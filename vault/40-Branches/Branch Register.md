...
| B2 | Theme | fantasy / cyberpunk-Japan futurism / 80s Bad Dudes action / other | **deferred** until human playtests establish fun; placeholder renderer now exists, [[ADR-0015-playable-demo-validation]] | low until art starts, high after |
...
| B6 | Mob generator | scripted waves / procedural wave budget / player-sent enemies / spawner buildings | budget composer retained; raid-source removal reopened by [[ADR-0016-raid-heat-prototype]] | moderate |
| B7 | Economy signature | interest on banked gold / kill bounties / wave-clear bonus / early-send bonus | base [[ADR-0012-mazing-and-economy]] retained; raid/investment/pact prototypes under [[ADR-0016-raid-heat-prototype]] | moderate (this is the knife edge itself) |
| B8 | Weapon system | flat upgrades / element combination / gem socketing / synergy tags | three support/status labs ready for human trial under [[ADR-0018-drop-dependent-playtest-checkpoint]]; final balance uncalibrated | moderate |
...
| B11 | Session length | 10-min mobile runs / 25-30-min runs / 30-45-min desktop runs | compact18-wave prototype supersedes prior duration target for this trial, [[ADR-0016-raid-heat-prototype]] | moderate |
...
| B13 | Balance tooling depth | spreadsheet only / headless Monte Carlo / solver-based difficulty ceiling | provisional greedy bounds + execution profiles implemented; full ceiling and human calibration pending, [[ADR-0015-playable-demo-validation]] | moderate |

## Parked directions

- Concept C's spawner-and-heat generator: reopened as a comparative prototype by [[ADR-0016-raid-heat-prototype]], not yet the converged chassis.
- Concept A's wall-piece territory income: parked; designated rewind target for B4 per [[ADR-0012-mazing-and-economy]].
- Elemental support combinations: reopened for the playable mechanic lab by [[ADR-0017-status-and-support-engine-lab]]. Gem fusion remains parked.
